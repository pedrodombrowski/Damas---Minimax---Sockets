...
public class VisaoDoTabuleiro extends JPanel {
	...
	/**
	 * Boolean sincronizada que faz a organiza��o entre as duas threads
	 * informando se o servidor est� conectado ou n�o
	 * 
	...
	/**
	 * M�todo respons�vel pela atribui��o da boolean que informa se o servidor
	 * est� conectado e libera��o das threads em estado de espera
	 * 
...
class ServStart implements Runnable {
	...
	/**
	 * Construtor do in�cio do servidor
	 * 
	 * @param tabuleiro
...
class Serv implements Runnable {
								...
								if (visao.servidorConectado == true) {
									if (visao.tabuleiro.ganhador() == 0) {
										...
										if (!pontuou) {
											...
											System.out.println("Pontua��o: eu: " + visao.eu + ", oponente: " + visao.oponente);
	...
	public class Conversor {
		 ...
		 * 
		 * @param posicao
		 *            posi��o no meu protocolo
		 * @param x
		 *            posi��o de linha do protocolo da turma
		 * @param y
		 *            posi��o de coluna do protocolo da turma
		 */
